...
workd<-getwd()
output <- readRDS(paste0(workd,"/output_wPubid.rds"))

#set levels
metadata <- read_xlsx(paste0(workd,"/J14113_metadataM_wPubID.xlsx"))
...
ggdf$pubID <- factor(output$meta_data$pubID[match(ggdf$sample_id,output$meta_data$sample_ids)], levels = ptlevels)
ggdf$condition <- factor(output$meta_data$condition[match(ggdf$sample_id,output$meta_data$sample_ids)], levels = conditionlevels)

ggdf_A<-ggdf[ggdf$condition=="A",]
ggdf_A<-ggdf_A[ggdf_A$timepoint!="C4D1",]
ggdf_A<-ggdf_A[ggdf_A$pubID!="J14113_P86",] #remove unpaired sample

ggdf_B<-ggdf[ggdf$condition=="B",]
ggdf_B<-ggdf_B[ggdf_B$timepoint!="C4D1",]
ggdf_B<-ggdf_B[ggdf_B$pubID!="J14113_P86",] #remove unpaired sample
...
ggdf<-ggdf[ggdf$timepoint!="C4D1",]
ggdf<-ggdf[ggdf$pubID!="J14113_P86",] #remove unpaired sample
...
ggdf2_A<-ggdf2_A[ggdf2_A$pubID!="J14113_P86",]
ggdf2_B<-ggdf2[ggdf2$condition=="B",]
ggdf2_B<-ggdf2_B[ggdf2_B$pubID!="J14113_P86",]
