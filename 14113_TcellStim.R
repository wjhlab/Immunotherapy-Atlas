...
metadata <- read_xlsx(paste0(workd,"/J14113_metadataTS_wPubID.xlsx"))

output <- readRDS(paste0(workd,"/output14113TS_wPubID.rds"))
...
ggdf$timepoint <- factor(output$meta_data$timepoint[match(ggdf$sample_id,output$meta_data$sample_ids)], 
                         levels = timepointlevels)
...
#for T cell oriented
pdf("abundanceLine_col_tp_AvB.pdf", width=7, height=8.5);lineplot_r_A; lineplot_r_B;dev.off()
pdf("abundanceLine_col_tp_AvB.pdf", width=7, height=8.5)
...
ggdf2<-ggdf2[ggdf2$pubID!="J14113_P86",]
...
#for lymphoid
pdf(paste0(workd,'/functionalLineplots_A.pdf'),width=8.5,height=8.5)
...
#for lymphoid
pdf(paste0(workd,'/functionalLineplots_B.pdf'),width=8.5,height=8.5)
...
#for lymphoid
pdf(paste0(workd,'/functionalLineplots_all.pdf'),width=8.5,height=8.5)
...
#for lymphoid
pdf(paste0(workd,'/functionalFCplots_AvB.pdf'),width=7,height=7)
