...
output <- readRDS(paste0(workd,"/results_October/output14113M_wPubid.rds"))
output$meta_data <- metadata

#set levels
metadata <- read_xlsx(paste0(workd,"/Config","/J14113_metadataM_wPubID.xlsx"))
...
output <- readRDS("E:/WJHLab/cytofAtlas/updated_data/J14113_PBMC/Myeloid/Myeloid/cellxgene_withPubID/output14113M_wPubid.rds")
...
plot_clustering_heatmap_wrapper2(fcs=output$fcs,
                                 ...
                                 subtype_markers=output$subtype_markers,
                                 fileName = paste0(workd,'/results_October/clusteringheatmap_merged_new.pdf'))
dev.off()
...
#for T cell oriented
pdf(paste0(workd,"/results_October/abundanceLine_col_tp_AvB.pdf"), width=7, height=8.5);lineplot_r_A; lineplot_r_B;dev.off()
pdf(paste0(workd,"/results_October/abundanceLine_col_tp_AvB_wstats.pdf"), width=7, height=8.5)
...
#for lymphoid
pdf(paste0(workd,"/results_October/abundanceLine_col_tp_both.pdf"), width=7, height=8.5);lineplot_r_all;dev.off()
pdf(paste0(workd,"/results_October/abundanceLine_col_tp_both_wstats.pdf"), width=7, height=8.5)
...
#for T cell oriented
pdf(paste0(workd,'/results_October/abundanceFCbars.pdf'),width=7,height=7);ggfcA;ggfcB;dev.off()

#for myeloid oriented
pdf(paste0(workd,'results_October/abundanceFCbars.pdf'),width=7,height=5);ggfcA;ggfcB;dev.off()
...
write.csv(ggdf_wide2_p[,c('cluster','p_value','diffAB')],paste0(workd,'/results_October/abundanceFC_AvB.csv'))
...
#for myeloid
pdf(paste0(workd,'/results_October/functionalLineplots_A.pdf'),width=8.5,height=5)
...
#for myeloid
pdf(paste0(workd,'/results_October/functionalLineplots_B.pdf'),width=8.5,height=5)
...
#for myeloid
pdf(paste0(workd,'/results_October/functionalLineplots_all.pdf'),width=8.5,height=5)
