...
metadata <- read_xlsx(paste0(workd,"/Config","/J1790_metadataM_added.xlsx"))
...
output <- output_wjh
#write.xlsx(metadata,paste0(workd,"/Config/J1790_metadataM_wPubID.xlsx"))

#output <- readRDS(paste0(workd,"/FinalRun/output_wPubid.rds"))
#newsamplelist <- readRDS(paste0(workd,"/FinalRun/1790Msamplelist.rds"))

#set levels
clusterMergeFile <- paste0(workd,"/Config",'/J1790_mergingM.xlsx')
...
saveRDS(output,paste0(workd,'/finalrun_revised/outputMyeloid_carter_fixed.rds'))
