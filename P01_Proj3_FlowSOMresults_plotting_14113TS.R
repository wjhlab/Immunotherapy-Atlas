...
write.xlsx(metadata,paste0(workd,"/Config/J14113_metadataTS_wPubID.xlsx"))
...
samplevels <- c("BT1_BC1", "BT1_BC2", "BT1_BC3", "BT1_BC4", "BT1_BC5", "BT1_BC6", "BT1_BC7",
                "BT1_BC8", "BT2_BC1", "BT2_BC2", "BT2_BC3", "BT2_BC4", "BT2_BC5", "BT2_BC6",
                "BT3_BC1", "BT3_BC2", "BT3_BC3", "BT3_BC4", "BT3_BC5", "BT3_BC6", "BT3_BC7",
                "BT3_BC8", "BT3_BC9", "BT4_BC1", "BT4_BC2", "BT4_BC3", "BT4_BC4", "BT4_BC5",
                "BT4_BC6", "BT4_BC7", "BT4_BC8", "BT5_BC1", "BT5_BC2", "BT5_BC3", "BT5_BC4",
                "BT5_BC5", "BT5_BC6", "BT5_BC7", "BT5_BC8", "BT6_BC1", "BT6_BC2", "BT6_BC3",
                "BT6_BC4", "BT6_BC5", "BT6_BC6", "BT6_BC7", "BT6_BC8", "BT7_BC1", "BT7_BC2",
                "BT7_BC3", "BT7_BC4", "BT7_BC5", "BT7_BC6", "BT7_BC7", "BT7_BC8", "BT7_BC9",
                "BT8_BC1", "BT8_BC2", "BT8_BC3", "BT8_BC4", "BT8_BC5", "BT8_BC6", "BT8_BC7",
                "BT8_BC8", "BT8_BC9", "BT9_BC1", "BT9_BC2", "BT9_BC3", "BT9_BC4", "BT9_BC5",
                "BT9_BC6", "BT9_BC7", "BT9_BC8", "BT9_BC9")
...
survivallevels=c("2.6","4.47","4.73","4.93","5.03","5.16","5.88","6.67","7.1","8.64",
                 "8.71","9.76","10.32","12.71","13.5","18.17","20.3","20.73","21.29",
                 "24.97","NA")
...
#for lymphoid
pdf(paste0(workd,'/FinalRun/functionalLineplots_A.pdf'),width=8.5,height=8.5)
#for myeloid
...
#for lymphoid
pdf(paste0(workd,'/FinalRun/functionalLineplots_B.pdf'),width=8.5,height=8.5)
#for myeloid
...
#for lymphoid
pdf(paste0(workd,'/FinalRun/functionalLineplots_all.pdf'),width=8.5,height=8.5)
#for myeloid
...
#for lymphoid
pdf(paste0(workd,'/FinalRun/functionalFCplots_AvB.pdf'),width=7,height=7)
#for myeloid
